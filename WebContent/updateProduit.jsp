...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid h4">
	...
	<div align="center" class="m-5 ">	<span class="login100-form-title" style="font-size: 40px; color: black;">Editer Produit nº ${ prodToUpdate.getIdProd() }</span>	</div>
<div class="wrapper fadeInDown" style="margin-top: -250px">
...
<form action="UpdateServlet?id=${ prodToUpdate.getIdProd() }" method="post" class="login100-form validate-form">
				...
				<div class="container-login100-form-btn">
					<input type="submit" name="save" value="Enregistrer" class="login100-form-btn">
						<a class="btn btn-info" href="ShowListServlet?act=2" >Annuler</a>
					 <br />
				</div>
