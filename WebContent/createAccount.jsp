...
<div class="wrapper fadeInDown" >
   ...
   <form action="InscriptionServlet" method="post" >
					...
					<div 
						...
						<input  type="text" name="nom" placeholder="Nom" value="<c:out value="${user.getNomUtil()}"/>" required="required">
					</div>
					<!-- Email -->
					...
					<div 
						...
						<input type="text" name="email"
							placeholder="Email"
							value="<c:out value="${ user.getEmailUtil() }"/>" required="required"> 
					</div>
					<!-- Adresse -->
					<div class="wrap-input100 validate-input"
						...
						<input type="text" name="adresse"
							placeholder="Adresse"
							value="<c:out value="${user.getAdresseUtil()}"/>" required="required">  
					</div>
					<!-- Password -->
					<div class="wrap-input100 validate-input"
      ...
      <!-- Remind Passowrd -->
      <div id="formFooter">
        <a class="underlineHover" href="index.jsp">déja client !</a>
      </div>
