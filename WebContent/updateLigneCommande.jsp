...
<nav class="navbar navbar-light bg-light">
  <div class="container-fluid h4">
	...
	<div align="center" class="m-5 ">	<span class="login100-form-title" style="font-size: 40px; color: black;">Editer ligne commande nº ${ lcmdToUpdate.getIdLigneCmd() }</span></div>
<div class="wrapper fadeInDown" style="margin-top: -200px">
...
<form action="UpdateServlet?id=${ lcmdToUpdate.getIdLigneCmd() }" method="post" class="login100-form validate-form">
				...
				<div class="container-login100-form-btn">
					...
					<a class="btn btn-info" href="ShowListServlet?act=4&id=${ lcmdToUpdate.getIdCmd() }" >Annuler</a> <br />
				</div>
	  ...
	  <div align="left"  style="margin-left:250px ;margin-top: -250px">
